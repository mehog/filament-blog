...
Route::middleware(config('filamentblog.route.middleware'))
    ...
    ->group(function () {
        ...
        Route::get('/{category:slug}', [CategoryController::class, 'posts'])->name('filamentblog.category.post');
    ...
    Route::middleware(config('filamentblog.route.middleware'))
    ->group(function () {
        Route::get('post-{post:slug}', [PostController::class, 'show'])->name('filamentblog.post.show');
    });
